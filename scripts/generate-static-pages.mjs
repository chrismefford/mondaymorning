...
const staticRoutes = [
  ...
  {
    path: "/locations/pacific-beach",
    title: "Non-Alcoholic Bottle Shop in Pacific Beach | Monday Morning",
    description: "Monday Morning's flagship non-alcoholic bottle shop and lounge in Pacific Beach. 500+ NA beers, wines, spirits and functional drinks, a tasting bar, free wifi, seating for 25, and easy parking. 1854 Garnet Ave.",
    ogImage: `${SITE_URL}/images/pacific-beach-location.jpg`,
    schema: [{
      "@context": "https://schema.org",
      "@type": "Store",
      name: "Monday Morning Bottle Shop, Pacific Beach",
      description: "Flagship non-alcoholic bottle shop and lounge in Pacific Beach, San Diego.",
      url: `${SITE_URL}/locations/pacific-beach`,
      image: `${SITE_URL}/images/pacific-beach-location.jpg`,
      telephone: "(858) 412-3253",
      address: { "@type": "PostalAddress", streetAddress: "1854 Garnet Ave", addressLocality: "San Diego", addressRegion: "CA", postalCode: "92109", addressCountry: "US" },
      parentOrganization: { "@type": "Organization", name: "Monday Morning Bottle Shop", url: SITE_URL },
      openingHoursSpecification: [
        { "@type": "OpeningHoursSpecification", dayOfWeek: ["Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], opens: "11:00", closes: "20:00" },
        { "@type": "OpeningHoursSpecification", dayOfWeek: ["Sunday"], opens: "11:00", closes: "18:00" },
      ],
    }],
  },
  {
    path: "/locations/ocean-beach",
    title: "Non-Alcoholic Bottle Shop in Ocean Beach | Monday Morning",
    description: "Monday Morning's beachside non-alcoholic bottle shop in Ocean Beach, one block from the sand. NA beer, wine, spirits, sunset kava slushies, and a tasting bar. 4967 Newport Ave.",
    ogImage: `${SITE_URL}/images/ocean-beach-location.jpg`,
    schema: [{
      "@context": "https://schema.org",
      "@type": "Store",
      name: "Monday Morning Bottle Shop, Ocean Beach",
      description: "Beachside non-alcoholic bottle shop in Ocean Beach, San Diego.",
      url: `${SITE_URL}/locations/ocean-beach`,
      image: `${SITE_URL}/images/ocean-beach-location.jpg`,
      telephone: "(858) 412-3253",
      address: { "@type": "PostalAddress", streetAddress: "4967 Newport Ave", addressLocality: "San Diego", addressRegion: "CA", postalCode: "92107", addressCountry: "US" },
      parentOrganization: { "@type": "Organization", name: "Monday Morning Bottle Shop", url: SITE_URL },
      openingHoursSpecification: [
        { "@type": "OpeningHoursSpecification", dayOfWeek: ["Tuesday", "Thursday"], opens: "11:00", closes: "20:00" },
